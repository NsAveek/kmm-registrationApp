...
@interface SharedBase_ : SharedBase
- (instancetype)initWithFields:(SharedFields *)fields __attribute__((swift_name("init(fields:)"))) __attribute__((objc_designated_initializer));
- (SharedFields *)component1 __attribute__((swift_name("component1()")));
- (SharedBase_ *)doCopyFields:(SharedFields *)fields __attribute__((swift_name("doCopy(fields:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedFields *fields __attribute__((swift_name("fields")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Base.Companion")))
@interface SharedBase_Companion : SharedBase
...
@interface SharedFields : SharedBase
- (instancetype)initWithUname:(NSString *)uname mobile:(NSString *)mobile password:(NSString *)password __attribute__((swift_name("init(uname:mobile:password:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (SharedFields *)doCopyUname:(NSString *)uname mobile:(NSString *)mobile password:(NSString *)password __attribute__((swift_name("doCopy(uname:mobile:password:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *mobile __attribute__((swift_name("mobile")));
@property (readonly) NSString *password __attribute__((swift_name("password")));
@property (readonly) NSString *uname __attribute__((swift_name("uname")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Fields.Companion")))
@interface SharedFieldsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ServiceApi")))
@interface SharedServiceApi : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)getUserUserEmail:(NSString *)userEmail completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getUser(userEmail:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ServiceApi.Companion")))
@interface SharedServiceApiCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (SharedBase_ *)serializerData:(NSString *)data __attribute__((swift_name("serializer(data:)")));
@end;
